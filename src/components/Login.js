...
const Login = () => {
  return (
    <Container>
      ...
      <Content>
        {/* <FirstImg src="/img/cta-logo-one.svg" alt="" /> */}
        <svg
          id="Layer_1"
          data-name="Layer 1"
        ...
        <LoginBtn>Get All Free</LoginBtn>
        <p>
          Get Premier Access to Raya and the Last Dragon for an additional fee
          with a Disney+ subscription. As of 03/26/21, the price of Disney+ and
          The Disney Bundle will increase by $1.
        </p>
        <SecondImg src="/img/cta-logo-two.png" alt="" />
      </Content>
    </Container>
  );
};
...
`;
const FirstImg = styles.img``;
const SecondImg = styles.img`margin: 10px 0;`;
